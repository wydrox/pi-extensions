...
export default function (pi: ExtensionAPI) {
	...
	// Only activate this extension when SSH mode is explicitly requested.
	// Otherwise it conflicts with other extensions that override core tools.
	const sshArgPresent = process.argv.some((arg) => arg === "--ssh" || arg.startsWith("--ssh="));
	if (!sshArgPresent) return;
